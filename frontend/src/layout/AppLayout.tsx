...
const HEADINGS: { prefix: string; title: string; subtitle: string }[] = [
  ...
  { prefix: '/notifications', title: 'Notifications', subtitle: 'Centre de notifications, lues et non lues.' },
  { prefix: '/profil', title: 'Mon profil', subtitle: 'Vos informations, votre mot de passe et vos préférences de notification.' },
